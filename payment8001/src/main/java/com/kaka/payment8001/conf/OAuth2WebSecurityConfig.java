package com.kaka.payment8001.conf;
...
public class OAuth2WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    public ResourceServerTokenServices tokenServices(){
        ...
        tokenServices.setClientId("admin");//在认证服务器配置的，订单服务的clientId
        tokenServices.setClientSecret("admin123456");//在认证服务器配置的，订单服务的ClientSecret
